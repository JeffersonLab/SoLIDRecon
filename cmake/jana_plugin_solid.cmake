...
macro(plugin_add _name)
    ...
    target_include_directories(${_name}_plugin PUBLIC ${SOLIDRECON_SOURCE_DIR}/src)
    ...
    if(${_name}_WITH_STATIC_LIB)
        ...
        add_library(${_name}_library STATIC "")
            target_include_directories(${_name}_library PUBLIC ${SOLIDRECON_SOURCE_DIR}/src)
...
macro(plugin_glob_all _name)
    ...
    string(REPLACE ${SOLIDRECON_SOURCE_DIR}/src "" PLUGIN_RELATIVE_PATH ${PROJECT_SOURCE_DIR})
